...
export const t = (d: Partial<Dict>, lang: Lang): string => d[lang] ?? d.en ?? "";
...
export const T = {
  ...
  testi1Role: { en: "Head of Rehabilitation, Charité Berlin", fa: "رئیس بخش توان‌بخشی، شاریته برلین", ar: "رئيس قسم التأهيل، شاريتيه برلين" },
  ...
  testi2Role: { en: "Procurement Director, NHS Trust", fa: "مدیر تأمین، NHS Trust", ar: "مدير المشتريات، NHS Trust" },
  ...
  testi3Role: { en: "Senior OT, Kessler Institute", fa: "کاردرمانگر ارشد، مؤسسه کسلر", ar: "أخصائي علاج وظيفي أول، معهد كيسلر" },
  // CTA form
